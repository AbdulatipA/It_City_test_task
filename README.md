...
Данный репозиторий содержит набор тестовых заданий для стажировки "ИТ-Город". Для выполнения задания необходимо сделать форк текущего репозитория, выполнить все задания
...
### Решение:
https://github.com/AbdulatipA/It_City_test_task/blob/master/src/test/java/ru/mos/qa/testtasks/tests/FileTests.java
